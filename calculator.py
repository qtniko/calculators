...
def keypress(key):
    if key.keysym=='1':output_update('1')
    if key.keysym=='2':output_update('2')
    if key.keysym=='3':output_update('3')
    if key.keysym=='4':output_update('4')
    if key.keysym=='5':output_update('5')
    if key.keysym=='6':output_update('6')
    if key.keysym=='7':output_update('7')
    if key.keysym=='8':output_update('8')
    if key.keysym=='9':output_update('9')
    if key.keysym=='0':output_update('0')
    if key.keysym=='period':dot()
    if key.keysym=='comma':dot()
    if key.keysym=='BackSpace':backspace()
    if key.keysym=='Delete':backspace()
    if key.keysym=='Escape':output_clear()
    if key.keysym=='Return':equals()
    if key.keysym=='equal':equals()
    if key.keysym=='plus':addition()
    if key.keysym=='minus':subtraction()
    if key.keysym=='asterisk':multiplication()
    if key.keysym=='slash':division()
#    if key.keysym=='exclam':factorial()
#    if key.keysym=='asciicircum':power()
    if key.keysym=='backslash':root()
